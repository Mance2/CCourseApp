package com.freexitnow.data_lib.network_register
...
import app.slyworks.coursecorrect.base.network.ConnectivityCallback
import app.slyworks.coursecorrect.base.network.NetworkWatcher
...
internal class NetworkWatcherImpl(private val context: Context) : NetworkWatcher {
    ...
    private lateinit var mConnectivityCallback: NetworkCallback
    private var mNetworkRequest: NetworkRequest
    private var mO:PublishSubject<Boolean> = PublishSubject.create()
    private lateinit var mFlow:MutableStateFlow<Boolean>
    //endregion
